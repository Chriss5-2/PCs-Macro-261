...
public class EPMapper {
    ...
    public static class MapperJob1 extends Mapper<LongWritable, Text, Text, Text> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (campos.length >= 13) {
                try {
                    // 🔥 CAMBIO AQUÍ: Extraemos Diagnóstico (7) y Género (8)
                    ...
                    if (!diagnostico.isEmpty() && !genero.isEmpty()) {
                        // La nueva llave compuesta será "Enfermedad | Género"
                        claveCompuesta.set(diagnostico + " | " + genero);
